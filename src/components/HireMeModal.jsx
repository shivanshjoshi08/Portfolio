...
const HireMeModal = ({ onClose, onRequest }) => {
	return (
		<motion.div
			...
			animate={{ opacity: 1 }}
			exit={{ opacity: 0 }}
			className="font-general-medium fixed inset-0 z-[100] transition-all duration-500 flex items-center justify-center p-4"
		>
			{/* Modal Backdrop */}
			<div className="bg-filter bg-black bg-opacity-50 absolute inset-0 w-full h-full"></div>

			{/* Modal Content */}
			<main className="flex flex-col items-center justify-center relative z-10 w-full h-full max-h-[90vh]">
				<div className="modal-wrapper flex items-center justify-center w-full h-full">
					<div className="modal w-full max-w-md mx-auto xl:max-w-xl lg:max-w-xl md:max-w-xl bg-secondary-light dark:bg-primary-dark max-h-full shadow-lg flex flex-col rounded-xl overflow-hidden relative">
